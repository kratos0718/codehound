...
Sixty checks. Eight are each backed by a bug that was actually
...
(CH007-CH009, CH012-CH050, CH052-CH057, CH059-CH060) are hardening rules
verified against real false positives across a ~29-framework validation
corpus instead - see docs/FINDINGS.md.
