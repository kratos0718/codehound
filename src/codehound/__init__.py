...
Eighty-eight checks. Eight are each backed by a bug that was actually
...
CH078-CH083, CH086-CH088) are hardening rules verified against real false
positives across a ~29-framework validation corpus instead - see
docs/FINDINGS.md.
