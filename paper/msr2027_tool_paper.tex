...
These patterns are well understood in principle, yet we found them in production paths of some of the most heavily used AI frameworks on GitHub. This artifact paper contributes:
...
\bibitem{asyncio} Python Software Foundation, ``asyncio --- Asynchronous I/O,'' Python Standard Library Documentation.
\bibitem{ruff} Astral, ``Ruff: An extremely fast Python linter,'' \url{https://github.com/astral-sh/ruff}.
\bibitem{bugbear} ``flake8-bugbear,'' \url{https://github.com/PyCQA/flake8-bugbear}.
\end{thebibliography}
